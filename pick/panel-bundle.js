...
var _idleJs = _interopRequireDefault(require("idle-js"));
...
var idle = new _idleJs.default({
  ...
  onIdle: function () {
    ...
    localStorage.setItem('loginOutData', (0, _moment.default)().format('LLLL'));
...
window.addEventListener('DOMContentLoaded', e => {
  fetch("http://localhost:3000/topick").then(res => res.json()).then(res => {
